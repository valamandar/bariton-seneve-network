                    ...
                    <div className="col-lg-6 col-md-12">
                        <div className="ai-about-content">
                            ...
                            <ul className="about-list">
                                <li><i className="fa-solid fa-check"></i> The Most Personalized Object Detection</li>
                                <li><i className="fa-solid fa-check"></i> We Create The Most Realistic AI</li>
                                <li><i className="fa-solid fa-check"></i> Innovative Machine Learning Products</li>
                            </ul>
